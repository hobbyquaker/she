...
- [I13 — Device discovery when adding an instance](#i13--device-discovery-when-adding-an-instance) 🚧 *(unblocked: `x-discover` landed in core 0.9.0)*
...
🚧 *Unblocked 2026-08-28: `x-discover` shipped in mqtt-interfaces-core 0.9.0 and in all four pilot adapters (hm2mqtt 3.3.0, lgsb2mqtt 2.1.0, cul2mqtt 1.2.0, wiim2mqtt 1.1.0).*
